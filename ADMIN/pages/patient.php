...
$patients = $conn->query("SELECT * FROM patient ORDER BY id DESC");
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <title>Patient's | Hospital</title>
</head>
<body>
    <div class="main">
        <div class="header">
        ...
        <div class="mid">
            <div class="title">
                Manage Patients
                <a class="add" href="./add-patient.php">Add Patient</a>
            </div>
            <div class="manage-Patient">
                <div class="Patient-label">Current Patient's</div>
                <div class="manage-main">
                    ...
                    <?php while ($row = $patients->fetch_assoc()): ?>
                        <div class="manage-box-content">
                            ...
                            <div class="content">
                                <div class="Action">
                                    <a class="edit" href="account-edit.php?role=patient&id=<?php echo $row['id']; ?>">Edit</a>
                                    <a class="delete" href="../../includes/delete_patient.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this patient?');">Delete</a>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
                    <?php else: ?>
                        <div class="manage-box-content">
                            <div class="content" colspan="4">No patients found</div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
