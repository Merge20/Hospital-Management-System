            ...
            <div class=" mid-items">
                <div class="mid-main1">
                    ...
                    <div class="mid-main1-box1 time">
                        <button class="disabled-time">9:00 AM</button>
                        <button class="available-time">9:30 AM</button>
                        <button class="available-time">10:00 AM</button>
                    </div>
                    <div class="mid-main1-box2 time">
                        <button class="available-time">11:30 AM</button>
                        <button class="disabled-time">12:00 PM</button>
                        <button class="available-time">12:30 PM</button>
                    </div>
                    <div class="mid-main1-box3 time">
                        <button class="available-time">1:00 PM</button>
                        <button class="disabled-time">1:30 PM</button>
                        <button class="available-time">2:00 PM</button>
                    </div>
                    <div class="mid-main1-box4 time">
                        <button class="available-time">2:30 PM</button>
                        <button class="available-time">3:00 PM</button>
                        <button class="available-time">3:30 PM</button>
                    </div>
                    <div class="mid-main1-box5 time">
                        <button class="available-time">4:00 PM</button>
                        <button class="available-time">4:30 PM</button>
                        <button class="available-time">5:00 PM</button>
                    </div>
                </div>
                <div class="mid-main2">
